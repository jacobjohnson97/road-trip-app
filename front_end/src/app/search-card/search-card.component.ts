...
export class SearchCardComponent implements OnInit {
  ...
  getTrip() {
    ...
    if (this.currentSearchType == SearchType.AREA_RADIUS) {
      request = `https://34.70.173.192:3000/api/v1/trips/calculatetrip?origin=${this.startLocationModel}&radius=${this.radiusModel}&num_waypoints=${this.stopsModel}&types=${this.getFilterTypes()}`;
      ...
      request = `https://34.70.173.192:3000/api/v1/trips/calculatetrip?origin=${this.startLocationModel}&destination=${this.endLocationModel}&num_waypoints=${this.stopsModel}&types=${this.getFilterTypes()}`;
      console.log(request)
