...
export class MyTripsComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.http.get(`http://localhost:3000/api/trip`, httpOptions).subscribe((response) => {
      ...
      buttons: [
        ...
        },
        {
          ...
          handler: () => {
            ...
            this.http.delete(`http://localhost:3000/api/trip?tripID=${this.trips[tripIndex]['_id']}`, httpOptions).subscribe((response) => {
